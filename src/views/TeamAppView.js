...
class TeamAppView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/TeamAppController')
  ...
  render() {
    const proxies = Controller !== TeamAppView ? transformProxies(this.props.children) : {
        ...
        <span className="af-view">
          <div>
            ...
            <div className="af-class-section-2">
              <div className="af-class-screen-container"><img src="images/Team-App-.jpg" srcSet="images/Team-App--p-500.jpeg 500w, images/Team-App--p-800.jpeg 800w, images/Team-App--p-1080.jpeg 1080w, images/Team-App-.jpg 1392w" sizes="(max-width: 479px) 90vw, (max-width: 767px) 94vw, (max-width: 991px) 87vw, (max-width: 1439px) 83vw, 928px" alt className="af-class-screen-image" /></div>
            </div>
